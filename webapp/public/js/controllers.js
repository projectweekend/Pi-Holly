...
cMod.controller( 'HomeCtrl', function ( $scope, socket, IndoorTempReporting, IndoorTemperatureCurrent, IndoorTemperatureStats, IndoorHumidityReporting, HueLighting ) {
